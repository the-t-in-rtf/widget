...
<html lang="en" manifest="/manifest.appcache">
  ...
  <head>
    ...
    <title>Updating and deleting documents</title>
    ...
    <header>
      ...
      <div class="page-head">
        ...
        <div class="container">
          ...
          <h1>Updating and deleting documents</h1>
  ...
  <div class="container">
    ...
    <a href="/guides/local-documents.html">Local documents</a>
        ...
        <div class="col-sm-9">
          <p>As we saw in the past two chapters, working with PouchDB documents can be tricky, because you have to manage the revision identifier <code>_rev</code>.</p>

<p>Now that we understand promises, though, there are few techniques we can use to make our code more elegant and readable.</p>

<h2>Creating a default document</h2>

<p>Often in our code, we&#39;ll want to <code>get()</code> a document, and if it doesn&#39;t exist, we want to create some default.</p>

<p>For instance, let&#39;s say we have a configuration object. We want to provide some reasonable defaults for our config:</p>
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="p">{</span>
  <span class="nx">_id</span><span class="o">:</span> <span class="s1">&#39;config&#39;</span><span class="p">,</span>
  ...
  <span class="nx">sparkly</span><span class="o">:</span> <span class="s1">&#39;false&#39;</span>
<span class="p">}</span>
</code></pre></div>
<p>This is a pretty good default setting! So let&#39;s write the code to set it as our default.</p>

<p>Thankfully, promises makes this rather easy:</p>
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">db</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;config&#39;</span><span class="p">).</span><span class="k">catch</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">if</span> <span class="p">(</span><span class="nx">err</span><span class="p">.</span><span class="nx">status</span> <span class="o">===</span> <span class="mi">404</span><span class="p">)</span> <span class="p">{</span> <span class="c1">// not found!</span>
    <span class="k">return</span> <span class="p">{</span>
      ...
      <span class="nx">sparkly</span><span class="o">:</span> <span class="s1">&#39;false&#39;</span>
    <span class="p">};</span>
  <span class="p">}</span> <span class="k">else</span> <span class="p">{</span> <span class="c1">// hm, some other error</span>
    <span class="k">throw</span> <span class="nx">err</span><span class="p">;</span>
  <span class="p">}</span>
<span class="p">}).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">configDoc</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// sweet, here is our configDoc</span>
<span class="p">}).</span><span class="k">catch</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="p">{</span>
...
<ul>
<li>Try to <code>get()</code> a doc with <code>_id</code> equal to <code>&#39;config&#39;</code></li>
<li>If it doesn&#39;t find it, return the default doc</li>
<li>Otherwise, you&#39;ll just get back the existing document</li>
</ul>

<p>You can see <strong><a href="http://bl.ocks.org/nolanlawson/0a01d466b2d331cf7e25">a live example</a></strong> of this code.</p>

<h2>Why must we dance this dance?</h2>

<p>A common question from new PouchDB/CouchDB users is: why do we have to deal with <code>_rev</code> at all? Why can&#39;t I just <code>put()</code> the document without providing a <code>_rev</code>?</p>

<p>The answer is: because <code>_rev</code>s are what makes sync work so well. PouchDB asks for a little upfront effort with managing document revisions, so that later on, sync is a breeze.</p>

<p>In fact, you are probably already familiar with a system that forces you to go through a similar dance. This system is called <a href="http://www.git-scm.com/">Git</a>.</p>
...
<div class="highlight"><pre><code class="language-text" data-lang="text">rev 3-a  rev 3-b
      \___/
        |    
      rev 2
        |
...
<div class="highlight"><pre><code class="language-text" data-lang="text">      rev 4
        |
      rev 3
        |    
      rev 2
...
<p>When you <code>remove()</code> a document, it&#39;s not really deleted; it just gets a <code>_deleted</code> attribute added to it.</p>

<p>That is, the database saves a tombstone at the end of the revision tree.</p>
<div class="highlight"><pre><code class="language-text" data-lang="text">{_id: &#39;foo&#39;, _rev: &#39;4-z&#39;, _deleted: true}
            |
{_id: &#39;foo&#39;, _rev: &#39;3-y&#39;}
            |    
{_id: &#39;foo&#39;, _rev: &#39;2-x&#39;}
...
<p>1) You can call <code>db.remove(doc)</code>:</p>
...
<p>2) You can call <code>db.remove(doc._id, doc._rev)</code>:</p>
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">db</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;mydoc&#39;</span><span class="p">).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">doc</span><span class="p">)</span> <span class="p">{</span>
...
<p>3) You can call <code>db.put(doc)</code> with <code>_deleted</code> set to <code>true</code>:</p>
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">db</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;mydoc&#39;</span><span class="p">).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">doc</span><span class="p">)</span> <span class="p">{</span>
...
<p>Of course, you will want to add <code>catch()</code> to the end of all these, unless you like to live dangerously.</p>

<p>You can see <strong><a href="http://bl.ocks.org/nolanlawson/b2049ad69308e92f15bc">a live example</a></strong> of this code.</p>
...
<li><a href="/api.html#delete_document">remove()</a></li>
</ul>

<h2>Next</h2>

<p>Now that we understand how to update and delete documents, let&#39;s do it in bulk.</p>
        ...
        <ul class="pager">
                ...
                <li class="previous">
                    <a href="/guides/async-code.html">&larr; Asynchronous code</a>
                </li>
            
            
                <li class="next">
                    <a href="/guides/bulk-operations.html">Bulk operations &rarr;</a>
                </li>
