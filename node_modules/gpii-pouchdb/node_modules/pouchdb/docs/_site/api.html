...
<li><code>options.ajax.headers</code>: The <code>ajax.headers</code> option allows you to customise headers that are sent to the remote HTTP Server.</li>
<li><code>options.auth.username</code> + <code>options.auth.password</code>: You can specify HTTP auth parameters either by using a database with a name in the form <code>http://user:pass@host/name</code> or via the <code>username</code> + <code>password</code> options.</li>
</ul>
...
<a class='h2 anchor' href='#delete_database' name='delete_database'>Delete a database</a>
...
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">db</span><span class="p">.</span><span class="nx">allDocs</span><span class="p">({</span><span class="nx">include_docs</span><span class="o">:</span> <span class="kc">true</span><span class="p">,</span> <span class="nx">attachments</span><span class="o">:</span> <span class="kc">true</span><span class="p">},</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">response</span><span class="p">)</span> <span class="p">{</span> <span class="p">});</span></code></pre></div>
...
<ul>
<li>The <code>&#39;complete&#39;</code> event only fires when you aren&#39;t doing live changes. With live changes, use the <code>&#39;paused&#39;</code> event instead.</li>
...
<li>The <code>&#39;since&#39;</code>option formerly took &#39;latest&#39; but has been changed to &#39;now&#39; to keep consistency with CouchDB. &#39;latest&#39; is deprecated but will still work to ensure backwards compatibility.</li>
</ul>
...
<p>Replication is an event emiter like <code>changes()</code> and emits the <code>&#39;complete&#39;</code>, <code>&#39;active&#39;</code>, <code>&#39;paused&#39;</code>, <code>&#39;change&#39;</code>, <code>&#39;denied&#39;</code> and <code>&#39;error&#39;</code> events.</p>
...
<li><code>options.retry</code>: If <code>true</code> will attempt to retry replications in the case of failure (due to being offline). Only applicable if <code>options.live</code> is also <code>true</code>.</li>
<li><code>options.filter</code>: Reference a filter function from a design document to selectively get updates.</li>
<li><code>options.query_params</code>: Query params sent to the filter function.</li>
<li><code>options.doc_ids</code>: Only replicate docs with these ids (array of strings).</li>
...
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="kd">var</span> <span class="nx">rep</span> <span class="o">=</span> <span class="nx">PouchDB</span><span class="p">.</span><span class="nx">replicate</span><span class="p">(</span><span class="s1">&#39;mydb&#39;</span><span class="p">,</span> <span class="s1">&#39;http://localhost:5984/mydb&#39;</span><span class="p">,</span> <span class="p">{</span><span class="nx">live</span><span class="o">:</span> <span class="kc">true</span><span class="p">})</span>
...
<ul>
<li><strong><code>change</code></strong> (<code>info</code>) - This event fires when the replication has written a new document. <code>info</code> will contain details about the change. See below for an example response.</li>
...
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">db</span><span class="p">.</span><span class="nx">putAttachment</span><span class="p">(</span><span class="nx">docId</span><span class="p">,</span> <span class="nx">attachmentId</span><span class="p">,</span> <span class="nx">rev</span><span class="p">,</span> <span class="nx">attachment</span><span class="p">,</span> <span class="nx">type</span><span class="p">,</span> <span class="p">[</span><span class="nx">callback</span><span class="p">]);</span></code></pre></div>
...
<span class="nx">db</span><span class="p">.</span><span class="nx">putAttachment</span><span class="p">(</span><span class="s1">&#39;a&#39;</span><span class="p">,</span> <span class="s1">&#39;text&#39;</span><span class="p">,</span> <span class="nx">rev</span><span class="p">,</span> <span class="nx">attachment</span><span class="p">,</span> <span class="s1">&#39;text/plain&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{})</span></code></pre></div>
