...
<h2>How attachments are stored</h2>
...
<p>By default, PouchDB will only give you an attachment <strong>stub</strong>, which contains a <code>digest</code>, i.e. the MD5 sum of the binary attachment.</p>
...
<h2>Directly storing binary data</h2>
...
<p>When you fetch attachments, however, <code>getAttachment()</code> will always return Blobs/Buffers, whereas
<code>get()</code>/<code>allDocs()</code>/<code>query()</code> with <code>{attachments: true}</code> will always return base64-encoded strings. </p>
