            ...
            function completeComments(res){
                    ...
                    jQuery.each(res.comments, function() {
                        numc = numc +1;
                        $("#widget_comments_ul").prepend("<li><img src='/src/img/user.png' alt='image of user' height='42' width='42'><span style='font-size: 14px;'><b>"+this.title+" ("+this.value+"/5):</b><br>"+this.c+"</span></li>");
                        
                        if(index===0){
                            $("#widget_first_comments_ul").prepend("<li><img src='/src/img/user.png' alt='image of user' height='42' width='42'><span style='font-size: 14px;'><b>"+this.title+" ("+this.value+"/5):</b><br>"+this.c+"</span></li>");
                        }
                        index++;
